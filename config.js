...
const baseConfig = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '94704020146-743595243@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'RGNK~jVM6AlEp').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "mr tin tin",
    ...
    SUDO: process.env.SUDO || "94743595243",
